...
Пример (дерево — [«01. Сквозной пример»](01-example-tree.md)): посеем маску в узле 2 (`group(1)`) и распространим вниз. Итерации (синхронные — все чтения из состояния предыдущего шага):
...
Пример: посеем маску в узле 10 (`kindB`) и распространим вверх.
