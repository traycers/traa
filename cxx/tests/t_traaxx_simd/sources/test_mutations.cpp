...
TEST(Mutations, MoveUnderOwnDescendantIsRejectedAndTreeUnchanged)
{
    ...
    EXPECT_EQ(result.error().kind, traaxx_simd::MoveError<std::uint32_t>::Kind::would_create_cycle);
